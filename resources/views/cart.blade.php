...
@section('content')
    ...
    <!-- Logout Modal-->
    <div class="modal fade" id="IniciaModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
                ...
                <div class="modal-body">
                 ...
                 <div class="modal-body">
                     ...
                     <form action="/session" method="POST">
                        @csrf
                        <input type="hidden" name="_token" value="{{csrf_token()}}">
                        <input type="text" value="8000" class="form-control" name="precio" placeholder="precio...">
